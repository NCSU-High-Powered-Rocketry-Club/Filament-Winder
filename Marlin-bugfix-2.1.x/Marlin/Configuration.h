...
#define STRING_CONFIG_H_AUTHOR "(BigTreeTech, Ender-3, Alex Key)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "NCSU Contraption 0.0.0"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 2.924567, 0.55555556, 0.55555556, 1}
