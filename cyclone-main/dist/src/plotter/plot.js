...
function plotGCode(gcode) {
    ...
    // TODO: validate these
    const windingParameters = JSON.parse(headerLineParts.slice(2).join(' '));
    const canvas = (0, canvas_1.createCanvas)(windingParameters.mandrel.windLength, 360);
    ...
    for (const line of gcode) {
        ...
        for (const segment of (0, helpers_1.generateCoordinates)({ x: xCoord, y: yCoord }, { x: nextXCoord, y: nextYCoord })) {
